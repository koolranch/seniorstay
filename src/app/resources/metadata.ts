...
export const metadata: Metadata = {
  title: 'Senior Living Resources & Guides | Cleveland, OH | Guide for Seniors',
  ...
  openGraph: {
    ...
    description: 'Expert guides covering memory care, assisted living, pricing, and choosing the right senior living community in Cleveland.',
    url: 'https://www.guideforseniors.com/resources',
