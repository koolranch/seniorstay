...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Senior Living Blog & Advice | Guide for Seniors Cleveland',
    description: 'Expert senior living advice for Cleveland families. Explore 60+ articles on assisted living costs, memory care, Medicare vs Medicaid, and local community guides.',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Senior Living Blog & Advice | Guide for Seniors Cleveland',
    description: 'Expert senior living advice for Cleveland families. Explore 60+ articles on assisted living costs, memory care, and local community guides.',
  },
};
