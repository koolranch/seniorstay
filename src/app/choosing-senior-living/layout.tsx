...
export const metadata: Metadata = {
  title: 'How to Choose Senior Living | Decision Guide | Guide for Seniors',
  ...
  openGraph: {
    ...
    description: 'Navigate the senior living decision with confidence. Learn warning signs, questions to ask, and how to choose between memory care and assisted living.',
    url: 'https://www.guideforseniors.com/choosing-senior-living',
...
export default function ChoosingSeniorLivingLayout({
  children,
}: {
