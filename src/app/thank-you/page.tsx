        ...
        <div className="mt-8">
          <Link href="/" passHref>
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-6 py-3 bg-blue-600 text-white rounded-md font-medium font-semibold hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            >
              Return to Home
            </motion.button>
          </Link>
