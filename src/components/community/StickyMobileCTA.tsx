  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-white border-t border-gray-200 shadow-lg safe-area-pb">
      <div className="flex items-center gap-2 p-3">
        {/* Call Button */}
        <PhoneLink
          placement="community_sticky_mobile"
          className="flex-1 flex items-center justify-center gap-2 bg-teal-600 text-white font-semibold py-3 px-4 rounded-lg hover:bg-teal-700 transition-colors min-h-[48px]"
        >
